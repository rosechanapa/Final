...
function MainApp({ subjectId, pageNumber }) {
  ...
  const handleGenerate = async () => {
    const response = await fetch('http://127.0.0.1:5000/generate', {
      ...
      body: JSON.stringify({ selected_case: selectedCase, range_input: rangeInput, subject_id: subjectId, page_number: pageNumber }),
    });
